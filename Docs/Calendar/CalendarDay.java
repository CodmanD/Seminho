...
public final class CalendarDay implements Parcelable {
     ...
     */
    @NonNull
    public static com.prolificinteractive.materialcalendarview.CalendarDay today() {
     ...
     */
    @NonNull
    public static com.prolificinteractive.materialcalendarview.CalendarDay from(int year, int month, int day) {
        return new com.prolificinteractive.materialcalendarview.CalendarDay(year, month, day);
    }
     ...
     * @return CalendarDay set to the specified date
     */
    public static com.prolificinteractive.materialcalendarview.CalendarDay from(@Nullable Calendar calendar) {
        if (calendar == null) {
            return null;
        }
        return from(
     ...
     * @return CalendarDay set to the specified date
     */
    public static com.prolificinteractive.materialcalendarview.CalendarDay from(@Nullable Date date) {
        if (date == null) {
            return null;
        }
     ...
     *
     * @see com.prolificinteractive.materialcalendarview.CalendarDay#today()
     */
    @Deprecated
    public CalendarDay() {
     ...
     * @see com.prolificinteractive.materialcalendarview.CalendarDay#from(Calendar)
     */
    @Deprecated
     ...
     * @see com.prolificinteractive.materialcalendarview.CalendarDay#from(Date)
     */
    @Deprecated
     ...
     */
    public boolean isInRange(@Nullable kodman.seminho.Calendar.CalendarDay minDate, @Nullable kodman.seminho.Calendar.CalendarDay maxDate) {
     ...
     */
    public boolean isBefore(@NonNull kodman.seminho.Calendar.CalendarDay other) {
        if (other == null) {
     ...
     */
    public boolean isAfter(@NonNull kodman.seminho.Calendar.CalendarDay other) {
        if (other == null) {
            throw new IllegalArgumentException("other cannot be null");
        }
    ...
    public boolean equals(Object o) {
        ...
        kodman.seminho.Calendar.CalendarDay that = (kodman.seminho.Calendar.CalendarDay) o;
    ...
    public static final Creator<kodman.seminho.Calendar.CalendarDay> CREATOR = new Creator<kodman.seminho.Calendar.CalendarDay>() {
        public kodman.seminho.Calendar.CalendarDay createFromParcel(Parcel in) {
            return new kodman.seminho.Calendar.CalendarDay(in);
        }

        public kodman.seminho.Calendar.CalendarDay[] newArray(int size) {
            return new kodman.seminho.Calendar.CalendarDay[size];
        }
    };
}
